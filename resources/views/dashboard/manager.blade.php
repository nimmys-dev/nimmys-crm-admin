    ...
    <div class="main-dashboard-content">
        ...
        <div class="stats-grid-5">
            <a href="{{ route('tasks.index', ['filter' => 'overdue','my_tasks' => 1]) }}" class="dash-card theme-overdue">
                ...
                <h3 class="dash-card-value">{{ $adminOverdueTaskCount ?? 0 }}</h3>
            ...
            <a href="{{ route('tasks.index', ['filter' => 'ongoing','my_tasks' => 1]) }}" class="dash-card theme-today">
                ...
                <h3 class="dash-card-value">{{ $adminOngoingTaskCount ?? 0 }}</h3>
            ...
            <a href="{{ route('tasks.index', ['filter' => 'upcoming','my_tasks' => 1]) }}" class="dash-card theme-upcoming">
                ...
                <h3 class="dash-card-value">{{ $adminUpcomingTaskCount ?? 0 }}</h3>
            ...
            <a href="{{ route('tasks.approval.index', ['filter' => 'pending','my_tasks' => 1]) }}" class="dash-card theme-pending">
                ...
                <h3 class="dash-card-value">{{ $adminApprovalPendingTaskCount ?? 0 }}</h3>
            ...
            <a href="{{ route('tasks.sending-approval') }}" class="dash-card theme-sending">
                ...
                <h3 class="dash-card-value">{{ $adminSendingPendingTaskCount ?? 0 }}</h3>
        ...
        <div class="section-title-wrap">
            <h4 class="section-title">All Task</h4>
            <a href="{{ route('tasks.index') }}" class="view-all-link">View All <i class="ti ti-arrow-right"></i></a>
        </div>
        <div class="stats-grid-5">
            <a href="{{ route('tasks.index', ['filter' => 'overdue']) }}" class="dash-card theme-overdue">
                <div class="dash-card-icon"><i class="ti ti-alert-circle"></i></div>
                <h3 class="dash-card-value">{{ $overdueDuty ?? 0 }}</h3>
                <span class="dash-card-label">Overdue Duty</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>

            <a href="{{ route('tasks.index', ['filter' => 'ongoing']) }}" class="dash-card theme-today">
                <div class="dash-card-icon"><i class="ti ti-calendar-event"></i></div>
                <h3 class="dash-card-value">{{ $todayDuty ?? 0 }}</h3>
                <span class="dash-card-label">Today's Duty</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>

            <a href="{{ route('tasks.index', ['filter' => 'upcoming']) }}" class="dash-card theme-upcoming">
                <div class="dash-card-icon"><i class="ti ti-clock"></i></div>
                <h3 class="dash-card-value">{{ $upcomingDuty ?? 0 }}</h3>
                <span class="dash-card-label">Upcoming Duty</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>

            <a href="{{ route('tasks.approval.index', ['filter' => 'pending']) }}" class="dash-card theme-pending">
                <div class="dash-card-icon"><i class="ti ti-briefcase"></i></div>
                <h3 class="dash-card-value">{{ $approvalPending ?? 0 }}</h3>
                <span class="dash-card-label">Approval Pending</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>
            ...
            <a href="{{ route('tasks.sending-approval') }}" class="dash-card theme-sending">
                <div class="dash-card-icon"><i class="ti ti-send"></i></div>
                <h3 class="dash-card-value">{{ $sendingApproval ?? 0 }}</h3>
                <span class="dash-card-label">Sending Approval</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>
        </div>
        ...
        {{-- SECTION 4: ALL LEADS --}}
        <div class="section-title-wrap">
            <h4 class="section-title">All Leads</h4>
            <a href="{{ route('leads.index', ['filter' => 'total_leads']) }}" class="view-all-link">View All <i class="ti ti-arrow-right"></i></a>
        </div>
        <div class="stats-grid-4">
            <a href="{{ route('leads.index', ['filter' => 'all_unattended']) }}" class="dash-card theme-unattended">
                <div class="dash-card-icon"><i class="ti ti-users"></i></div>
                <h3 class="dash-card-value">{{ $statistics['unattended'] ?? 0 }}</h3>
                <span class="dash-card-label">Unattended Leads</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>

            <a href="{{ route('leads.index', ['filter' => 'all_overdue_followup']) }}" class="dash-card theme-overdue">
                <div class="dash-card-icon"><i class="ti ti-user-plus"></i></div>
                <h3 class="dash-card-value">{{ $statistics['overdue_followup'] ?? 0 }}</h3>
                <span class="dash-card-label">Overdue Follow Up</span>
                <div class="dash-card-arrow"><i class="ti ti-arrow-right"></i></div>
            </a>
