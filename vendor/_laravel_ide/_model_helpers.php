...
namespace App\Models {
	 ...
	 * @property \App\Enums\ShopStatus $status
	 * @property \Illuminate\Support\Carbon|null $opened_on
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereAddressLine($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereCity($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereState($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop wherePostalCode($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereCountry($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereOpenedOn($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereStatus($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop whereNotes($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop search(?string $term) {@see App\Models\Shop::scopeSearch()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop status(\App\Enums\ShopStatus|string|null $status) {@see App\Models\Shop::scopeStatus()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop city(?string $city) {@see App\Models\Shop::scopeCity()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop managedBy(?int $managerId) {@see App\Models\Shop::scopeManagedBy()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Shop>|Shop sorted(?string $column, ?string $direction) {@see App\Models\Shop::scopeSorted()}
	 ...
	 * @property boolean $lead_module_access
	 * @property boolean $increment_notification
	 * @property float|null $increment_amount
	 * @property \Illuminate\Support\Carbon|null $increment_date
	 ...
	 * @property-read \App\Models\Shop $managedShop
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereEmployeeCode($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereAlternatePhone($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereJoiningDate($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereSalary($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereIncrementDate($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereIncrementAmount($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereIncrementNotification($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereLeadModuleAccess($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User role(\App\Enums\UserRole $role) {@see App\Models\User::scopeRole()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User forShop(?int $shopId) {@see App\Models\User::scopeForShop()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User search(?string $term) {@see App\Models\User::scopeSearch()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User filterRole(\App\Enums\UserRole|string|null $role) {@see App\Models\User::scopeFilterRole()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User filterStatus(\App\Enums\UserStatus|string|null $status) {@see App\Models\User::scopeFilterStatus()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User dueForIncrementReminder(?int $withinDays = null) {@see App\Models\User::scopeDueForIncrementReminder()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User withLeadAccess() {@see App\Models\User::scopeWithLeadAccess()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User filterShop(string|int|null $shopId) {@see App\Models\User::scopeFilterShop()}
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User sorted(?string $column, ?string $direction) {@see App\Models\User::scopeSorted()}
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
